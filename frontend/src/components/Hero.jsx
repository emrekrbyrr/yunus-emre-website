  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#FEFEFE]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Accent Lines */}
        <div className="hidden md:block absolute top-1/4 left-10 w-32 h-1 bg-gradient-to-r from-[#8B7355] to-transparent"></div>
        <div className="hidden md:block absolute bottom-1/3 right-10 w-40 h-1 bg-gradient-to-l from-[#A0826D] to-transparent"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#FAF7F0] border border-[#E8DFD4] rounded-full mb-6">
              ...
              <span className="text-sm text-[#6B5D52] font-medium">Developer Engineer</span>
            </div>
            ...
            <div className="relative max-w-md mx-auto">
              ...
              <div className="relative bg-white p-2 rounded-3xl shadow-2xl">
                ...
                <div className="absolute -bottom-4 -left-4 bg-white p-3 rounded-xl shadow-xl border-2 border-[#FAF7F0] transform hover:scale-110 transition-all duration-300">
                  ...
                  <div className="text-xs text-[#6B5D52] font-medium">Mühendislik Deneyimi</div>
                </div>
